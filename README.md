...
By default all chapters and pages are created as a draft. If you want to render these pages, remove the property `draft = true` from the metadata file (located in /content/intro/_index.en.md)
...
From here, follow the instructions within the pages to build out your workshop.